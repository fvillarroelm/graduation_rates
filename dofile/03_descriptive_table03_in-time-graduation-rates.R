...
# load existing file
excel_file <- loadWorkbook(here("results", "tables", "descriptive","03_descriptive_table03.xlsx"))
...
saveWorkbook(excel_file, 
             here("results", "tables", "descriptive","03_descriptive_table03.xlsx"), 
             overwrite = TRUE)
